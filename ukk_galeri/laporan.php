        ...
        <div class="col-md-6 profile-card">
            <div class="row">
                <div class="col-md-4 text-center">
                    <img src="assets/img/anime1.jpeg" class="img-fluid rounded-circle" alt="Gambar Profil">
                </div>
                <div class="col-md-8">
                    <h2>azkya adnafika</h2>
                    <h3>XII PPLG 3</h3>
                    <h3>SMKN 4 BOGOR</h3>
                    <p><strong>Email:</strong> azkyaadnafika24@gmail.com</p>
                    <h3>Media Sosial</h3>
                    <a href="https://www.instagram.com/azkyaadnafikaaa/" class="btn btn-custom mr-2">Instagram</a>
                    <a href="https://www.youtube.com/@Azkyaadnafika6" class="btn btn-custom">Youtube</a>
                </div>
            </div>
        </div>
    </div>
